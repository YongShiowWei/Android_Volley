...
isset($_POST['question4']) && isset($_POST['correctAns4']) && isset($_POST['wrongAns4_1']) && isset($_POST['wrongAns4_2']) && isset($_POST['wrongAns4_3']) ){
	...
	$correctAns1 = $_POST['correctAns2'];
	$wrongAns1_1 = $_POST['wrongAns2_1'];
	$wrongAns1_2 = $_POST['wrongAns2_2'];
	$wrongAns1_3 = $_POST['wrongAns2_3'];
    $question1 = $_POST['question3'];
	$correctAns1 = $_POST['correctAns3'];
	$wrongAns1_1 = $_POST['wrongAns3_1'];
	$wrongAns1_2 = $_POST['wrongAns3_2'];
	$wrongAns1_3 = $_POST['wrongAns3_3'];
    $question1 = $_POST['question4'];
	$correctAns1 = $_POST['correctAns4'];
	$wrongAns1_1 = $_POST['wrongAns4_1'];
	$wrongAns1_2 = $_POST['wrongAns4_2'];
	$wrongAns1_3 = $_POST['wrongAns4_3'];
